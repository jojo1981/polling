...
class PollExceptionChecker
{
     ...
     * @return bool
     */
    public function checkException(Throwable $exception, array $arguments, Collection $previousResults, int $currentPollCount): bool
    {
        return call_user_func($this->callback, ...array_merge($arguments, $this->arguments, [$exception, $previousResults, $currentPollCount]));
    }
}
